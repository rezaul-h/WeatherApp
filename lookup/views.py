...
def home(request):
	...
	if request.method == "POST":
		...
		api_requests=requests.get("https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" +zipcode+ "&distance=5&API_KEY=F1EA73D8-041B-4AAF-B030-52177D8F6052")
		...
		api_requests=requests.get("https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=89129&distance=5&API_KEY=F1EA73D8-041B-4AAF-B030-52177D8F6052")
		try:
			api = json.loads(api_requests.content)
		except Exception as e:
			api = "Error..."
